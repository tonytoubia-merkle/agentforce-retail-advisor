...
const HERO_IMAGES = [
  ...
  },
  {
    ...
    prompt: [
      ...
      'Soft warm lighting with subtle shimmer.',
      'Pure white background (#FFFFFF) with objects creating elegant composition.',
    ].join(' '),
  },
  {
    ...
    prompt: [
      ...
      'Soft bokeh lighting, romantic and sophisticated.',
      'High-end perfume advertisement style.',
      'Pure white background (#FFFFFF) for easy composition.',
    ].join(' '),
  },
  {
