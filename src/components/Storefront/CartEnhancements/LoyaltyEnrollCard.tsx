...
export const LoyaltyEnrollCard: React.FC<{ minimumSubtotal?: number }> = ({
  ...
  return (
    <motion.div
      ...
      className="mb-4 rounded-xl border border-amber-200 bg-linear-to-r from-amber-50 to-white p-4 flex items-center gap-4 shadow-sm"
    >
      <div className="shrink-0 w-10 h-10 rounded-full bg-amber-500/10 flex items-center justify-center text-amber-600">
