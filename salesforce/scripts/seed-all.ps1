...
# ================================================================
# PHASE 2 - PORTFOLIOS & CONTACTS
# ================================================================
Write-Host "-- Phase 2: Portfolios and Clientelling Data --" -ForegroundColor Cyan
Run-Apex "setup-demo-portfolios.apex"    "Demo portfolios"
Run-Apex "seed-clientelling-data.apex"   "Clientelling contacts and profiles"
...
# ================================================================
Write-Host "-- Phase 4: Journeys and Engagement --" -ForegroundColor Cyan
...
# ================================================================
Write-Host "-- Phase 6: Fixes and Patches --" -ForegroundColor Cyan
...
Write-Host "============================================================" -ForegroundColor Green
Write-Host ""
Write-Host "Check any WARN lines above in Setup > Apex Jobs."
Write-Host ""
...
Write-Host "        See AGENTFORCE_SETUP_GUIDE.md for OAuth and .env setup"
Write-Host ""
